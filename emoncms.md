...
### Screenshot
![](http://lancet.mit.edu/mwall/projects/weather/weewx-on-emoncms.png)
...
`setup.py install --extension weewx-emoncms-x.y.tgz2.  Modify weewx.conf:`
~~~~
[StdRESTful]
    [[EmonCMS]]
        token = TOKEN3.  Restart weewx
~~~~
### Options
