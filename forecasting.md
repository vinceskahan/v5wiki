...
[Engines]
   archive_services = ... , user.forecast.ZambrettiForecast2.  Restart weewx
~~~~
...
[Engines]
   archive_services = ... , user.forecast.WUForecast2.  Restart weewx
~~~~
sudo /etc/init.d/weewx stop
sudo /etc/init.d/weewx start
~~~~
...
[Engines]
   archive_services = ... , user.forecast.NWSForecast2.  Restart weewx
~~~~
sudo /etc/init.d/weewx stop
sudo /etc/init.d/weewx start
~~~~
...
[Engines]
   archive_services = ... , user.forecast.XTideForecast2.  Restart weewx
~~~~
sudo /etc/init.d/weewx stop
sudo /etc/init.d/weewx start3.  Display tide data
~~~~
### Screenshots
