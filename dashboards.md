...
<p>
The reports are generated by invoking wee_reports periodically, typically using cron.
</p>
</td>
</tr>
</table>
...
<p>
On a separate computer, the `wee_report` utility runs regularly to generate one or more larger reports that aggregate data from all of the weeWX instances.  Data for the reports are retrieved from the network-accessible database.
</p>
<p>
The reports are generated by invoking wee_reports periodically, typically using cron.
</p>
