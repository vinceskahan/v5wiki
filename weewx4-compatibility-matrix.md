...
|---|---|---|---|---|
| debian10 | weewx-4.0.0b18 | `dpkg -i` | 22apr2020 | FAIL: stop does not stop |
| debian10 | weewx-3.9.2 to weewx-4.0.0b18 | `dpkg -i` | 22apr2020 | FAIL: stop does not stop |
...
| debian9 | weewx-3.9.2 to weewx-4.0.0b18 | `dpkg -i` | 22apr2020 | FAIL: stop does not stop |
